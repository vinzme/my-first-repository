...
#Region "Events"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If pubUser.Trim = "BELLE" Then
            pubUser = "IBRAHIM.BELLE"
        End If

        If pubUser.Trim = "ROBIN.POOLE" Then
            CheckFFTag()
            If pubFFTag = "0" Then
                Response.Redirect("MgtReportFF.aspx")
            End If
        End If
                ...
                While mReader.Read()
                    ...
                    Select Case Trim(mReader("report_module").ToString)
                        Case "1"
                            ...
                            If UCase(Trim(mReader("username").ToString)) = "RAMZI LOUZA" Then
                        ...
                        Case "2"
                            ...
                            If UCase(Trim(mReader("username").ToString)) = "RAMZI LOUZA" Then
                                ImageButton2.ImageUrl = "~/images/md_img2.gif"
                                ImageButton7.ImageUrl = "~/images/content2_md.gif"

                                ImageButton2.PostBackUrl = "~/MDDivisionIncome.aspx"
                                ImageButton7.PostBackUrl = "~/MDDivisionIncome.aspx"

                                ImageButton2.Attributes.Add("onmouseover", "this.src='images/md_img2_on.gif'")
                                ImageButton2.Attributes.Add("onmouseout", "this.src='images/md_img2.gif'")

                                ImageButton7.Attributes.Add("onmouseover", "this.src='images/content2_md_on.gif'")
                                ImageButton7.Attributes.Add("onmouseout", "this.src='images/content2_md.gif'")
                        ...
                        Case "3"
                            ...
                            If UCase(Trim(mReader("username").ToString)) = "RAMZI LOUZA" Then
                                ...
                                ImageButton3.ImageUrl = "~/images/md_img3.gif"
                                ImageButton8.ImageUrl = "~/images/content3_md.gif"

                                ImageButton3.PostBackUrl = "~/MDBalanceSheet.aspx"
                                ImageButton8.PostBackUrl = "~/MDBalanceSheet.aspx"

                                ImageButton3.Attributes.Add("onmouseover", "this.src='images/md_img3_on.gif'")
                                ImageButton3.Attributes.Add("onmouseout", "this.src='images/md_img3.gif'")

                                ImageButton8.Attributes.Add("onmouseover", "this.src='images/content3_md_on.gif'")
                                ImageButton8.Attributes.Add("onmouseout", "this.src='images/content3_md.gif'")
                        ...
                        Case "4"
                            ...
                            If UCase(Trim(mReader("username").ToString)) = "RAMZI LOUZA" Then
                                ...
                                ImageButton4.ImageUrl = "~/images/md_img4.gif"
                                ImageButton10.ImageUrl = "~/images/content4_md.gif"

                                ImageButton4.PostBackUrl = "~/MDMarginReport.aspx"
                                ImageButton10.PostBackUrl = "~/MDMarginReport.aspx"

                                ImageButton4.Attributes.Add("onmouseover", "this.src='images/md_img4_on.gif'")
                                ImageButton4.Attributes.Add("onmouseout", "this.src='images/md_img4.gif'")

                                ImageButton10.Attributes.Add("onmouseover", "this.src='images/content4_md_on.gif'")
                                ImageButton10.Attributes.Add("onmouseout", "this.src='images/content4_md.gif'")
                            ...
                            Else
                                ...
                                ImageButton10.Attributes.Add("onmouseover", "this.src='images/content3_on.gif'")
                                ImageButton10.Attributes.Add("onmouseout", "this.src='images/content3.gif'")
                        ...
                        Case "5"
                            ...
                            If UCase(Trim(mReader("username").ToString)) = "RAMZI LOUZA" Then
                                ...
                                ImageButton5.ImageUrl = "~/images/md_img5.gif"
                                ImageButton11.ImageUrl = "~/images/content5_md.gif"

                                ImageButton5.PostBackUrl = "~/MDLabour.aspx"
                                ImageButton11.PostBackUrl = "~/MDLabour.aspx"

                                ImageButton5.Attributes.Add("onmouseover", "this.src='images/md_img5_on.gif'")
                                ImageButton5.Attributes.Add("onmouseout", "this.src='images/md_img5.gif'")

                                ImageButton11.Attributes.Add("onmouseover", "this.src='images/content5_md_on.gif'")
                                ImageButton11.Attributes.Add("onmouseout", "this.src='images/content5_md.gif'")
                        ...
                        Case "6"
                            ...
                            If UCase(Trim(mReader("username").ToString)) = "RAMZI LOUZA" Then
                                ...
                                ImageButton12.ImageUrl = "~/images/md_img6.gif"
                                ImageButton13.ImageUrl = "~/images/content7_md.gif"

                                ImageButton12.PostBackUrl = "http://secure.saudi-ericsson.com/receivables/receivables.aspx"
                                ImageButton13.PostBackUrl = "http://secure.saudi-ericsson.com/receivables/receivables.aspx"

                                ImageButton12.Attributes.Add("onmouseover", "this.src='images/md_img6_on.gif'")
                                ImageButton12.Attributes.Add("onmouseout", "this.src='images/md_img6.gif'")

                                ImageButton13.Attributes.Add("onmouseover", "this.src='images/content7_md_on.gif'")
                                ImageButton13.Attributes.Add("onmouseout", "this.src='images/content7_md.gif'")
            ...
            If mReader.HasRows Then
                While mReader.Read()
                    ...
                    Select Case Trim(mReader("designation"))
                        ...
                        Case "MD"
                            Image1.ImageUrl = "~/images/name_imageMD.gif"
                    End Select
...
#End Region
        ...
        If DropDownList1.Text.Trim = "2011" Then
            ...
            If pubUserPosition = "Manager" Then
                cmdUpdate.CommandText = "Update and_user_selected_month set selected_month = 'January'," & _
                        ...
                        "', selected_year = '2011' where rtrim(userid) = '" & pubUserManager.Trim & "'"
            Else
                cmdUpdate.CommandText = "Update and_user_selected_month set selected_month = 'January'," & _
                        "selected_date = '" & pubServerDate & _
                        "', selected_year = '" & DropDownList1.Text.Trim & "' where rtrim(userid) = '" & pubUser.Trim & "'"
    ...
    Private Sub CheckFFTag()
        ...
        Try
            ...
            sSql = "Select fftag from and_user_login where userid_check = 'ROBIN.POOLE'"
