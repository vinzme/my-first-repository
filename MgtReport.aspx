<%@ Page Language="VB" masterpagefile="~/MasterPage4.master" AutoEventWireup="false" CodeFile="MgtReport.aspx.vb" Inherits="MgtReportMgr" %>
                ...
                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; height: 100%; text-align: right;">
                    <tr>
                        <td style="width: 100px; background-color: #ebebef;">
                            <asp:Image ID="Image1" runat="server" ImageUrl="~/images/name_image8.gif" /></td>
                         <td>
                        ...
                        <td style="text-align: right; background-image: url(images/name_spacer.gif);">
                            <asp:ImageButton ID="ImageButton9" runat="server" ImageUrl="~/images/memo.gif" PostBackUrl="~/MgtMemos.aspx" ImageAlign="Right" />
                        </td>
                    </tr>
                </table>
            </td>
            ...
            <td style="width: 558px; height: 435px;">
                ...
                <table style="width: 263px; height: 428px">
                    ...
                    <tr>
                        ...
                        <td style="vertical-align: middle; width: 100px">
                            <asp:ImageButton ID="ImageButton12" runat="server" ImageUrl="~/images/md_img6.gif" /></td>
                        <td style="vertical-align: middle; width: 100px">
                            <asp:ImageButton ID="ImageButton13" runat="server" ImageUrl="~/images/content7_md.gif" /></td>
                    </tr>
                </table>
            </td>
        </tr>
