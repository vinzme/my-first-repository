        ...
        Select Case RadioButtonList1.SelectedValue
            ...
            Case 0
                ...
                If Val(pubUserMonth) < 10 Then
                    strPeriod = pubUserYear.Trim & "0" & pubUserMonth
                Else
                    strPeriod = pubUserYear.Trim & pubUserMonth
                End If

                params1(0) = New ReportParameter("Period", strPeriod.Trim)
                If RadioButtonList2.SelectedValue = 0 Then
                    params2(0) = New ReportParameter("MtdYtd", "M")
                Else
                    params2(0) = New ReportParameter("MtdYtd", "Y")
                End If
            ...
            Case 2
                ...
                Response.Redirect("MgtLabVar.aspx")
