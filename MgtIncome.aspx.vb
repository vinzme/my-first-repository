...
Partial Class MgtIncome
    ...
    Private Sub GetUserCategory()
        ...
        Try
            i = 0
            sSql = "Select income from and_user_user_costcenter where rtrim(userid) = '" & pubUser.Trim & _
                    "' and report_module = '1' group by income"
            ...
            If mReader.HasRows Then
                ...
                While mReader.Read()
                    ...
                    pubUserCat = Trim(mReader("income"))
                    If pubUserCat = "division" Then
                        RadioButtonList1.Items(0).Text = "Jeddah Branch"
                        RadioButtonList1.Items(1).Text = "Jeddah Region"
                    End If
        ...
        Try
            ...
            If mReader.HasRows Then
                ...
                While mReader.Read()
                    ...
                    Label1.Text = "Income Statement for the Month of " & _
    ...
    Private Sub GetCostCentre()
        ...
        Try
            ...
            sSql = "Select cost_centre as division from and_user_user_costcenter where rtrim(userid) = '" & _
                    pubUser.Trim & "' and report_module = '1' order by cost_centre"
            ...
            If mReader.HasRows Then
                ...
                While mReader.Read()
                    i = i + 1
                    strDivision = strDivision & Trim(mReader("division".Trim))
                End While
            ...
            Select Case pubUserCat
                Case "cc"
                    If RadioButtonList1.SelectedValue = 0 Then
                        ReportViewer1.ServerReport.ReportPath = "/MIS Reports/Income Statement by CC"
                    Else
                        ReportView2.ServerReport.ReportPath = "/MIS Reports/Income Statement by CC"
                    End If
                Case "division"
                    If RadioButtonList1.SelectedValue = 0 Then
                        ReportViewer1.ServerReport.ReportPath = "/MIS Reports/Income Statement by Division"
                    Else
                        ReportView2.ServerReport.ReportPath = "/MIS Reports/Income Statement by Division"
                    End If
                Case "single"
                    If RadioButtonList1.SelectedValue = 0 Then
                        ReportViewer1.ServerReport.ReportPath = "/MIS Reports/Income Statement Single"
                    Else
                        ReportView2.ServerReport.ReportPath = "/MIS Reports/Income Statement Single"
                    End If
            End Select


            params1(0) = New ReportParameter("CostCentre", strTemp)
            params2(0) = New ReportParameter("Year", Mid(pubUserYear, 3, 2))
            params3(0) = New ReportParameter("Month", pubUserMonth)
            If RadioButtonList1.SelectedValue = 0 Then
                params4(0) = New ReportParameter("RepType", "M")
            ...
            Else
                params4(0) = New ReportParameter("RepType", "Y")
                ReportView2.ServerReport.SetParameters(params1)
                ReportView2.ServerReport.SetParameters(params2)
                ReportView2.ServerReport.SetParameters(params3)
                ReportView2.ServerReport.SetParameters(params4)
