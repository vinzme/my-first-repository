<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MDCompanyIncome.aspx.vb" Inherits="MDCompanyIncome" %>
...
<head runat="server">
    <title>Company Income Statement</title>
    <script> 
if(!window.opener){ 
            ...
            <tr>
                ...
                <td style="width: 100px; background-color: aliceblue; text-align: right;">
                    <asp:RadioButtonList ID="RadioButtonList1" runat="server" Font-Bold="True" Font-Names="Verdana"
                        ...
                        <asp:ListItem Value="0" Selected="True">Income Statement</asp:ListItem>
                        <asp:ListItem Value="1">Operating Statement</asp:ListItem>
                        <asp:ListItem Value="2">Financial Results</asp:ListItem>
        ...
        <asp:MultiView ID="MultiView1" runat="server">
            <asp:View ID="View1" runat="server">
                <rsweb:ReportViewer ID="ReportViewer1" runat="server" Height="618px" ProcessingMode="Remote"
                    ...
                    <ServerReport ReportPath="/MIS Reports/Income Statement by Division MD" ReportServerUrl="http://inside.saudi-ericsson.com/reportserver" />
                </rsweb:ReportViewer>
            </asp:View>
            <asp:View ID="View2" runat="server">
                <rsweb:ReportViewer ID="ReportViewer2" runat="server" Height="688px" ProcessingMode="Remote"
                    Width="100%" Font-Names="Verdana" Font-Size="8pt" ShowDocumentMapButton="False" ShowExportControls="False" ShowFindControls="False" ShowPageNavigationControls="False" ShowPromptAreaButton="False" ShowRefreshButton="False">
                    <ServerReport ReportPath="/MIS Reports/Operating Statement" ReportServerUrl="http://inside.saudi-ericsson.com/reportserver" />
                </rsweb:ReportViewer>
            </asp:View>
            <asp:View ID="View3" runat="server">
                <rsweb:ReportViewer ID="ReportViewer3" runat="server" Font-Names="Verdana" Font-Size="8pt"
                    Height="688px" ProcessingMode="Remote" Width="100%" ShowDocumentMapButton="False" ShowExportControls="False" ShowFindControls="False" ShowPageNavigationControls="False" ShowPromptAreaButton="False" ShowRefreshButton="False">
                    <ServerReport ReportPath="/MIS Reports/Financial Results" ReportServerUrl="http://inside.saudi-ericsson.com/reportserver" />
                </rsweb:ReportViewer>
            </asp:View>
