...
Partial Class MgtCostCentre
    ...
    Private Sub GetUserCategory()
        ...
        Try
            i = 0
            sSql = "Select category from and_user_table where rtrim(userid) = '" & pubUser.Trim & "' and report_module = '3'"
        ...
        Try
            ...
            If mReader.HasRows Then
                ...
                While mReader.Read()
                    ...
                    Label1.Text = "Cost Centre Report for the Month of " & _
                            Trim(mReader("repmonthdes".Trim)) & " " & pubUserYear
                    pubUserMonthDes = Trim(mReader("repmonthdes".Trim))
    ...
    Private Sub GetCostCentre()
        ...
        Try
            ...
            sSql = "Select cost_centre from and_user_user_costcenter where rtrim(userid) = '" & _
                pubUser.Trim & "' and report_module = '3' order by cost_centre"
            ...
            If RadioButtonList1.SelectedValue = 0 Then
                params2(0) = New ReportParameter("Period", pubUserYear & " " & pubUserMonthDes)
