...
Partial Class MgtMargin
    ...
    Private Sub GetUserCategory()
        ...
        Try
            i = 0
            sSql = "Select margin_option, margin_value from and_user_margin where rtrim(userid) = '" & _
                    pubUser.Trim & "' order by margin_value"
            ...
            If mReader.HasRows Then
                ...
                While mReader.Read()
                    ...
                    RadioButtonList1.Items.Add(Trim(mReader("margin_option".Trim)))
                    RadioButtonList1.Items(i).Value = Trim(mReader("margin_value".Trim))
                    i = i + 1
                End While
    ...
    Private Sub GetCostCentre()
        ...
        Try
            ...
            sSql = "Select cost_centre from and_user_user_costcenter where rtrim(userid) = '" & _
                pubUser.Trim & "' and report_module = '4'"
                ...
                Case "Graph"
                    ...
                    Select Case RadioButtonList1.SelectedValue
                        Case 0
                            ...
                            ReportViewer1.ServerReport.ReportPath = "/MIS Reports/Gross Margin Graph"
                            ReportViewer1.ServerReport.SetParameters(params1)
                            ReportViewer1.ServerReport.SetParameters(params2)
                            ReportViewer1.ServerReport.SetParameters(params3)
                        ...
                        Case 1
                            ...
                            params2(0) = New ReportParameter("MMonth", strPeriod)
                            params3(0) = New ReportParameter("MYear", Mid(pubUserYear, 3, 2))
                            ReportViewer2.ServerReport.ReportPath = "/MIS Reports/Gross Margin Graph"
                            ReportViewer2.ServerReport.SetParameters(params1)
                            ReportViewer2.ServerReport.SetParameters(params2)
                            ReportViewer2.ServerReport.SetParameters(params3)
                        ...
                        Case 2
                            ...
                            params2(0) = New ReportParameter("MMonth", strPeriod)
                            params3(0) = New ReportParameter("MYear", Mid(pubUserYear, 3, 2))
                            ReportViewer3.ServerReport.ReportPath = "/MIS Reports/Gross Margin Graph"
                            ...
                            ReportViewer3.ShowZoomControl = True
                        ...
                        Case 3
                            ...
                            params2(0) = New ReportParameter("MMonth", strPeriod)
                            params3(0) = New ReportParameter("MYear", Mid(pubUserYear, 3, 2))
                            ReportViewer4.ServerReport.ReportPath = "/MIS Reports/Gross Margin Graph"
                            ...
                            ReportViewer4.Height = "596"
                            ReportViewer4.ShowZoomControl = True
                ...
                Case "By Order"
                    Select Case RadioButtonList1.SelectedValue
                        Case 0
                            ...
                            params2(0) = New ReportParameter("month", strPeriod)
                            params3(0) = New ReportParameter("CostCentre", strTemp)
                            params4(0) = New ReportParameter("type", "C")
                            ReportViewer1.ServerReport.ReportPath = "/MIS Reports/Margin by Project"
                            ReportViewer1.ServerReport.SetParameters(params1)
                            ReportViewer1.ServerReport.SetParameters(params2)
                            ReportViewer1.ServerReport.SetParameters(params3)
                            ReportViewer1.ServerReport.SetParameters(params4)
                        ...
                        Case 1
                            ...
                            params3(0) = New ReportParameter("CostCentre", strTemp)
                            params4(0) = New ReportParameter("type", "C")
                            ReportViewer2.ServerReport.ReportPath = "/MIS Reports/Margin by Project"
                            ReportViewer2.ServerReport.SetParameters(params1)
                            ReportViewer2.ServerReport.SetParameters(params2)
                            ReportViewer2.ServerReport.SetParameters(params3)
                            ReportViewer2.ServerReport.SetParameters(params4)
                        ...
                        Case 2
                            ...
                            params3(0) = New ReportParameter("CostCentre", strTemp)
                            params4(0) = New ReportParameter("type", "C")
                            ReportViewer3.ServerReport.ReportPath = "/MIS Reports/Margin by Project"
                            ReportViewer3.ServerReport.SetParameters(params1)
                            ReportViewer3.ServerReport.SetParameters(params2)
                            ReportViewer3.ServerReport.SetParameters(params3)
